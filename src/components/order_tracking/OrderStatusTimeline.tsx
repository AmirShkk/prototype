...
const getIconForStage = (id: string): string => {
...
export default function OrderStatusTimeline({ stages = [] }: OrderStatusTimelineProps) {
        ...
        return (
          <div key={stage.id} className="relative flex gap-4 pb-8 last:pb-0 group">
            ...
            <div className="flex flex-col pt-1.5">
              ...
              {stage.timestamp && (
                <span className="text-caption mt-0.5">{stage.timestamp}</span>
              )}
